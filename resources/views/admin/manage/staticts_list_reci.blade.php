    ...
    <div class="main-content">
        <div class="row justify-content-between mx-0">
            ...
            <div class="form-group col-4 mb-0 text-right mt-3">
                <button class="btn btn-add-cus"><i _ngcontent-pqj-c26="" class="fa fa-plus-circle mr-1"></i>Thêm mới</button>
            </div>
        </div>
        <div class="table-create-order d-flex mt-2 ml-2 font-weight-bold row">
            ...
            <div class="form-group col-md-3">
                <div class="">
                    ...
                    <input type="tel" class="form-control form-reci" id="phone" placeholder="Nhập tên/số điện thoại" />
                </div>
            </div>
